...
{{--                    @foreach($cart as $data)--}}
{{--                        @foreach($data->products as $cartProducts)--}}
{{--                                {{$cartProducts}}--}}
                        <button wire:click="checkout()" class="border-2 text-sm uppercase w-full text-center border-blue-700 rounded-full font-bold text-blue-700 px-4 py-3 transition duration-300 ease-in-out hover:bg-blue-500 hover:text-white">pereiti prie apmokėjimo</button>
{{--                    @endforeach--}}
{{--                    @endforeach--}}
                    </div>
