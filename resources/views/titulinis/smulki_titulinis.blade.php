<section class=" my-14 container px-10">
    ...
    <div class="bg-gray-200 p-2 border-t-4 border-solid border-blue-500">
        <h2 class="font-sans font-semibold text-xl ml-2"><i class="text-blue-500 text-2xl fas fa-laptop-house"></i> SMULKI BUITINĖ TECHNIKA</h2>
    </div>
    <div class="px-6 py-6 border border-gray-200  owl-carousel owl-theme bg-white rounded">
        @foreach ($smulkiProducts as $product)
    ...
    <div class="flex justify-end mt-10">
        <a href="{{ route('category_list', [$smulki->link]) }}" class=" font-semibold text-indigo-600 text-lg ">
            Peržiūrėkite visus produktus
        </a>
        <a href="{{ route('category_list', [$smulki->link]) }}">
