        ...
        <div class="sm:flex sm:mt-8">
            <div class="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col lg:flex-row justify-between">
                <div class="flex flex-col">
                    ...
                    <hr>
                    <span class="my-2"><a href="#" class="text-white py-1 text-md hover:text-white-500">D.U.K</a></span>
                    <span class="my-2"><a href="#" class="text-white py-1 text-md hover:text-white-500">Pristatymas</a></span>
                    <span class="my-2"><a href="#" class="text-white py-1 text-md hover:text-white-500">Grąžinomo sąlygos</a></span>
                ...
                <div class="flex flex-col mt-1">
                        ...
                        <hr>
                        <span class="my-2"><a href="#" class="text-white py-1 text-md hover:text-white-500">Apie mus</a></span>
                        <span class="my-2"><a href="#" class="text-white py-1 text-md hover:text-white-500">Parduotuvės teisės ir informacija</a></span>
