    ...
    <div class="inline mr-16 flex flex-grow pb-4 md:pb-0">
        ...
        <a href="{{ route('cart') }}">
            <svg class="relative w-6 h-6 m-2 stroke-current text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span class="z-50 absolute top-7 ml-7 text-xs inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-blue-700 rounded-full">3</span>
            </svg>
        </a>
        @endif
